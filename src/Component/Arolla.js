...
function Arolla({mountaindesc, setMountaindesc, inputField, inputsHandler, handleSubmit, success, setSuccess, isValid, btnRef}) {
  ...
  const [ref, inView] = useInView();
    ...
    return (
        ...
        {mountaindesc && <div className='MountainDesc'>
              ...
              <div className='MountainDesc-card'>
                ...
                <div className='MountainDesc-header'>
                  ...
                  <Carousel showStatus={false} showThumbs={false} swipeable={true} autoPlay={true} infiniteLoop={true}>
                    <img src={require("./image/arolla1.jpg")} className='DescImg' alt=''/>
                    <img src={require("./image/arolla2.jpg")} className='DescImg' alt=''/>
                  </Carousel>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className='Desc-title'>
                    <h2 >Arolla Camp</h2>
                    <p>Camping Arolla - Route de Tsallion, 8 - 1986 Arolla - Suisse</p>
                  </div>
                    ...
                    <div className='Desc-tent'>
                        <div className='tent-text' onChange={inputsHandler}>
                          ...
                          <div className='icon-tent'>
                              ...
                              <label className='tent-label'><GiBarracksTent className='tent_' /> Tent </label>
                ...
                <Link to='explore' spy={true} smooth={true} hashSpy={true} onClick={() => setMountaindesc(false)} className='back-btn-icon'>back</Link> 
                </div>
       ...
       {success && <div className='message'>
        <div className='message-container'>
          ...
          <BsCheckCircle className='msg-icon'/>
            ...
            <p>check your booking payment</p>
